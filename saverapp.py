...
We used Object Oriented Programming for the login/register process
"""
...
if choice == "yes":
    ...
    my_user = Register("username", "password", "email")

print("HELLO! IN ORDER TO TRACK YOUR EXPENSES CORRECTLY, WE WILL NEED MORE INFORMATION ABOUT YOU.")
print("")
